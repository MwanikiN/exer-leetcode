...
def division(dividend, divisor):
    ...
    # Handle edge case of divisor being 0
    if divisor == 0:
        return INT_MAX if dividend >= 0 else INT_MIN
    
    sign = -1 if (dividend < 0) ^ (divisor < 0) else 1
    
    # Make both dividend and divisor positive for easier handling
    ...
    while dividend >= divisor:
        ...
        # Subtract divisor << (shift - 1) from dividend and update quotient
